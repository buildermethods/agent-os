...
The index enables the `agent-os-inject-standards` skill to suggest relevant standards without reading all files. It maps each standard to a brief description for quick matching.
...
2. Ask the user to confirm a proposed description:
...
- If standards suggestions seem out of sync
- To clean up a messy or outdated index

**Note:** `agent-os-discover-standards` runs this automatically as its final step, so you usually don't need to invoke it separately after discovering standards.
