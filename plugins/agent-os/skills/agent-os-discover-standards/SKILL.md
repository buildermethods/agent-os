...
Check if the user specified an area when invoking this skill. If they did, skip to Step 2.
...
2. For each new file without an index entry, ask:
...
> The `agent-os-index-standards` skill implements this step in full. Follow it if you need the complete indexing rules.
